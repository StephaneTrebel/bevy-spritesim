...
- In the future we will handle different terrain "speed", so better to acknowledge for a "difficulty" ranging from 0 (unpassable) to 100 (fully passable without penalty)
- Not all Units behave the same way. Boats do not care about Oceans (but they care about Rivers), but Land units do not know how to swim 😁
