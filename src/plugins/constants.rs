...
pub const SPRITE_MAP_SIZE: f32 = 24.; // Size of a sprite side length, in pixels
pub const SPRITE_DISPLAY_SIZE: f32 = 16.; // Size of a sprite side length, in pixels when drawn
